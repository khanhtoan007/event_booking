	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100" >
				<form class="login100-form validate-form" style="padding-top: 100px;" action="${pageContext.request.contextPath}/register" method="POST" onsubmit="return validateForm()">
					...
					<div class="container-login100-form-btn mt-5">
						...
						<a href="${pageContext.request.contextPath}/login" class="txt1 mt-3 ">
							Login now
						</a>
					</div>
