					...
					<form action="${pageContext.request.contextPath}/add-more-info" method="post">
								...
								<div class="col-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="gender"
											...
											request.getAttribute("gender").equals("true") ? "checked" : "" : "" %>>
								...
								<div class="col-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="gender"
											...
											<%=request.getAttribute("gender")!=null ?
											request.getAttribute("gender").equals("false") ? "checked" : "" : "" %>>
						...
						<div class="d-grid gap-2 mt-2">
							<button type="submit" class="btn btn-primary">
								<%= language.getString("update_info").toUpperCase() %>
							</button>
						</div>
					</form>
				</div>
