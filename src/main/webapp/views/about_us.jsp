                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                ...
                                <p class="mb-0"></p>Hãy để chúng tôi là điểm xuất phát cho những chuyến phiêu lưu đầy ý nghĩa và đắm chìm trong sự huyền bí của Hội An. Cùng chúng tôi khám phá những câu chuyện và bí mật của những nghệ nhân tài năng, những bức tranh lịch sử và văn hóa độc đáo mỗi khi bạn bước chân vào một làng nghề mới.</p>
                                <p class="mb-0"></p>Chúng tôi mong muốn được kết nối bạn với những trải nghiệm đặc sắc nhất tại Hội An. Xin chân thành cảm ơn bạn đã chọn chúng tôi làm đối tác du lịch trong hành trình của mình!</p>
                            </div>
                        </div>
                    </div>
                </div>
