                ...
                <form action="new-post" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="title" placeholder="Title" value="${eventPost.title}">
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-9">
                            ...
                            <textarea class="form-control" name="description" id="content" rows="10">${eventPost.content}</textarea>
                        </div>

                        <div class="col-md-3">
                            <label for="start_date" class="form-label">Start date:</label>
                            <input type="date" class="form-control" id="start_date" name="start_date" value="${eventPost.start_date}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-9">
                            ...
                            <input type="text" name="location" class="form-control" id="location"
                                placeholder="Location" value="${eventPost.location}">
                        </div>
                    </div>
