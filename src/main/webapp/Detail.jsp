                ...
                <div class="ps-lg-3">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 col-6 mb-3">
                            <label class="mb-2 d-block">Số lượng</label>
                ...
                <div class="border rounded-2 px-3 py-2 bg-white">
                    ...
                    <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                        <li class="nav-item d-flex" role="presentation">
                            <a class="nav-link d-flex align-items-center justify-content-center w-100 active" id="ex1-tab-1" data-mdb-toggle="pill" href="#ex1-pills-1" role="tab" aria-controls="ex1-pills-1" aria-selected="true">About</a>
                        </li>
                        <li class="nav-item d-flex" role="presentation">
                            <a class="nav-link d-flex align-items-center justify-content-center w-100" id="ex1-tab-2" data-mdb-toggle="pill" href="#ex1-pills-2" role="tab" aria-controls="ex1-pills-2" aria-selected="false">Ticket </a>
                        </li>
                        <li class="nav-item d-flex" role="presentation">
