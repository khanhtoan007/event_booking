...
<header class="app-header">
    ...
    <ul class="app-nav">
        ...
        <!-- User Menu-->
        <li><a class="app-nav__item" href="login.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a>
...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item">Danh sách Poster</li>
            <li class="breadcrumb-item"><a href="#">Thêm Poster</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            <a class="btn btn-add btn-sm" data-toggle="modal" data-target="#exampleModalCenter"><b><i
                                    class="fas fa-folder-plus"></i> Tạo Poster mới</b></a>
                        </div>
